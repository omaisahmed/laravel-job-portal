                    ...
                    <div class="card-body card-form">
                        <div class="d-flex justify-content-between">
                            ...
                            <div style="margin-top: -10px;">
                                <a href="{{ route('admin.posts.create') }}" class="btn btn-primary">Post a Blog</a>
                            </div>
                        </div>
                                            ...
                                            <td>
                                                <div class="action-dots">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li><a class="dropdown-item" href="{{ route('admin.posts.edit',$post->id) }}"><i class="fa fa-edit" aria-hidden="true"></i> Edit</a></li>
