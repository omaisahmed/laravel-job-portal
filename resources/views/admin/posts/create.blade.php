    ...
    <div class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <form action="" method="post" id="createPostForm" name="createPostForm" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" placeholder="Sub Title" id="subtitle" name="subtitle" class="form-control">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="mb-4 col-md-12">
                                    <label for="" class="mb-2">Write Post Here<span class="req">*</span></label>
